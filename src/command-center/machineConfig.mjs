...
export const COMMAND_CENTER_MACHINES = Object.freeze([
  machine({
    ...
    name: 'News Array',
    shortName: 'News',
    description: 'Research and monitor public AI and gaming news.',
  ...
  machine({
    ...
    name: 'Repo Forge',
    shortName: 'Repos',
    description: 'Watch repositories and engineering signals for useful changes.',
  ...
  machine({
    ...
    name: 'Tool Scanner',
    shortName: 'Tools',
    description: 'Assess newly discovered AI and game-development tools for relevance.',
  ...
  machine({
    ...
    name: 'Agent Lab',
    shortName: 'Agents',
    description: 'Review agent and automation signals for useful workflow patterns.',
  ...
  machine({
    ...
    name: 'Model Furnace',
    shortName: 'Models',
    description: 'Compare model routing and infrastructure options.',
  ...
  machine({
    ...
    shortName: 'Creator',
    description: 'Shape vetted findings into creator-facing angles and private draft material.',
  ...
  machine({
    ...
    shortName: 'Profit',
    description: 'Assess market and partner signals for monetization opportunities.',
  ...
  machine({
    ...
    shortName: 'Playbooks',
    description: 'Turn findings and ideas into repeatable experiments.',
  ...
  machine({
    ...
    shortName: 'Letter',
    description: 'Distill vetted issue material into longer-form newsletter updates.',
  ...
  machine({
    ...
    name: 'X Uplink',
    shortName: 'X',
    description: 'Format vetted content signals for X and transmit only when a public post is linked.',
  ...
  machine({
    ...
    shortName: 'Publish',
    description: 'Hand vetted signals and drafts to Terminal or Beehiiv.',
  ...
  machine({
    ...
    shortName: 'Radar',
    description: 'Scout possibilities when Opportunity Scout telemetry is emitted.',
