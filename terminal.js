...
if (typeof document !== 'undefined') {
  ...
  initNewsletterSignup({
    panel: document.getElementById('terminal-newsletter'),
    form: document.getElementById('terminal-newsletter-form'),
    emailInput: document.getElementById('terminal-newsletter-email'),
    submitButton: document.getElementById('terminal-newsletter-submit'),
    status: document.getElementById('terminal-newsletter-status'),
    fallbackLink: document.getElementById('terminal-newsletter-fallback')
  });
  initDecodeLines();
}
